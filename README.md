...
A small Python project that compares temperatures in urban and rural locations and shows the Urban Heat Island effect.
...
Anyone can also use the deployed app directly by clicking the live link below.
...
- Live URL: [urban-heat-island-analysis-tool.streamlit.app](https://urban-heat-island-analysis-tool.streamlit.app/)

### Deploy to Streamlit Community Cloud

1. Open Streamlit Community Cloud and sign in with GitHub.
2. Click New app.
3. Select repository: KeiAraya/Urban-Heat-Island-Analysis-Tool.
...
- Free-tier apps may sleep when inactive.
- First load after sleep can take a short while.
